          ...
          <div className="Dashboard-view_1">
            <div className="row">
              <div className="bg-success col-3 ml-2">
                ...
                <h2>{Math.floor(1 + Math.random() * 1450)}</h2>
              </div>
        ...
        data: [
          {
            ...
            dataPoints: [
              { label: "Domingo", y: Math.floor(1 + Math.random() * 1000) },
              { label: "Segunda-Feira", y: Math.floor(1 + Math.random() * 1000) },
              { label: "Terça-Feira", y: Math.floor(1 + Math.random() * 1000) },
              { label: "Quarta-Feira", y: Math.floor(1 + Math.random() * 1000) },
              { label: "Quinta-Feira", y: Math.floor(1 + Math.random() * 1000) },
              { label: "Sexta-Feira", y: Math.floor(1 + Math.random() * 1000) },
              { label: "Sabado", y: Math.floor(1 + Math.random() * 1000) }
            ]
          },
          {
            name: "Ano de 2021",
